...
<!-- Promo End -->
    ...
    <div>
        <div style="text-align: center">
            ...
            <div style="width: 100%; background-image: url('gambar/contohgambar.png'); padding:5%">
              {{-- GAMBAR DIDALAM GAMBAR --}}
                <img src="gambar/contohgambar2.png" style="width: 25%; margin: 2%">
                <img src="gambar/contohgambar2.png" style="width: 25%; margin: 2%">
                <img src="gambar/contohgambar2.png" style="width: 25%; margin: 2%">
            </div>
            <a href="http://localhost:8000/destination"><button style="border-radius: 20px; background: linear-gradient(to right, orange, red); color: white; padding: 1%; padding-left: 3%; padding-right: 3%; translate: 0% -50%">See More</button></a>
    ...
    <div style="display: flex; text-align: justify">
        <div style="padding: 5%">
            ...
            <div style="text-align:center">
                <img src="gambar/contohgambar4.jpg" style="width: 100%">
                <a href="http://localhost:8000/homestay"><button style="border-radius: 20px; background: linear-gradient(to right, orange, red); color: white; padding: 2%; padding-left: 5%; padding-right: 5%; translate: 125% -150%">See More</button></a>
            </div>
        ...
        <div style="padding:5%">
            ...
            <div style="text-align:center">
                <img src="gambar/contohgambar3.jpg" style="width: 100%">
                <a href="http://localhost:8000/culinary"><button style="border-radius: 20px; background: linear-gradient(to right, orange, red); color: white; padding: 2%; padding-left: 5%; padding-right: 5%; translate: 125% -150%">See More</button></a>
            </div>
            <p style="font-weight: bold">
